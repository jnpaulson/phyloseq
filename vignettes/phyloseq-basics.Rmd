...
New versions of QIIME (see below) produce a more-comprehensive 
and formally-defined file format based on either JSON or HDF5,
usually names with a `.biom` extension:
